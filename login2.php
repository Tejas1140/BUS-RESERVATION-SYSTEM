...
<head>
  ...
  <title>Rent Management System Dashboard - Login</title>
...
<!-- SELECT * FROM rent_collector LEFT OUTER JOIN landlord ON landlord.landlord_email='$email' WHERE landlord.landlord_password='$password' AND landlord.landlord_email='$email' OR rent_collector.email='$email' AND rent_collector.password='$password' UNION SELECT * FROM rent_collector RIGHT OUTER JOIN landlord ON landlord.landlord_email='$email' WHERE landlord.landlord_password='$password' AND landlord.landlord_email='$email' OR rent_collector.email='$email' AND rent_collector.password='$password'; -->